...
public class MenuEquipo extends SeccionMenu {
	...
	private void dibujarPaneles(final Graphics g) {
		dibujarPanelObjetos(g, panelObjetos, titularPanelObjetos, "Equipacion");

		dibujarPanelEquipado(g, panelEquipo, titularPanelEquipo, "Equipado");
	...
	private void dibujarPanelEquipado(final Graphics g, final Rectangle panel, final Rectangle titularPanel,
			final String nombrePanel) {
		dibujarPanel(g, panel, titularPanel, nombrePanel);
	...
	private void dibujarPanel(final Graphics g, final Rectangle panel, final Rectangle titularPanel,
		...
		DibujoDebug.dibujarRectanguloContorno(g, panel, Constantes.COLOR_VERDE);
		DibujoDebug.dibujarRectanguloRelleno(g, titularPanel, Constantes.COLOR_AZUL);
		g.setColor(Constantes.COLOR_AMARILLO);
		DibujoDebug.dibujarString(g, nombrePanel,
				new Point(titularPanel.x + titularPanel.width / 2 - MedidorString.medirAnchoPixeles(g, nombrePanel) / 2,
