...
public class Mapa {
	...
	private Sprite[] asignarSprites(final String[] partesPaleta, final String[] hojasSeparadas) {
		...
		HojaSprites hoja = new HojaSprites("recursos/imagenes/hojastexturas/" + hojasSeparadas[0] + ".png", 32, false);
	...
	private void actualizarZonaSalida() {
		int puntoX = ((int) puntoSalida.getX()) * Constantes.LADO_SPRITE
				- ElementosPrincipales.jugador.obtenerPosicionXInt() + MARGEN_X - 16;
		int puntoY = ((int) puntoSalida.getY()) * Constantes.LADO_SPRITE
				- ElementosPrincipales.jugador.obtenerPosicionYInt() + MARGEN_Y - 16;
